# -*- coding: utf-8 -*-
"""
Created on Sat Dec  3 12:48:36 2022
...
data = [tuple(item.strip().split()) for item in data]

def round_score(opp, you):
...
out = [round_score(rnd[0], rnd[1]) for rnd in data]
print(sum(out))
...
out2 = [new_round_score(rnd[0], rnd[1]) for rnd in data]
print(sum(out2))
